...
void drawText(int x, int y, const char*mess) {
	...
	SetTextColor(device_context, RGB(200, 4, 65));
...
void setcolor(int color, int size)
{
	...
	switch (color)
	{
		case 0: PEN = getPen(PS_SOLID, size, RGB(0,0,0)); break;
		case 1: PEN = getPen(PS_SOLID, size, RGB(0,0,128)); break;
		case 2: PEN = getPen(PS_SOLID, size, RGB(0,128,0)); break;
		case 3: PEN = getPen(PS_SOLID, size, RGB(128,0,0)); break;
		case 4: PEN = getPen(PS_SOLID, size, RGB(0,128,128)); break;
		case 5: PEN = getPen(PS_SOLID, size, RGB(128,0,128)); break;
		case 6: PEN = getPen(PS_SOLID, size, RGB(128,128,0)); break;
		case 7: PEN = getPen(PS_SOLID, size, RGB(0,0,255)); break;
		case 8: PEN = getPen(PS_SOLID, size, RGB(0,255,0)); break;
		case 9: PEN = getPen(PS_SOLID, size, RGB(255,0,0)); break;
		case 10: PEN = getPen(PS_SOLID, size, RGB(0,255,255)); break;
		case 11: PEN = getPen(PS_SOLID, size, RGB(255,0,255)); break;
		case 12: PEN = getPen(PS_SOLID, size, RGB(255,255,0)); break;
		case 13: PEN = getPen(PS_SOLID, size, RGB(192,192,192)); break;
		case 14: PEN = getPen(PS_SOLID, size, RGB(192,192,192)); break;
